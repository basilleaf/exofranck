...
class PDFLabel(FPDF):
    ...
    def set_label_xy(self):
        pos_x = self.margin_left + self.countX * (self.width + self.space_x) + self.padding
        pos_y = self.margin_top + self.countY * (self.height + self.space_y) + self.padding
